...
class OrderGateway {
  public:
    OrderGateway(quantlink::SPSCQueue<OrderRequest>* outgoing, quantlink::SPSCQueue<OrderResponse>* incoming, quantlink::Logger* logger, const std::string& ip, int port, const std::string& iface);
